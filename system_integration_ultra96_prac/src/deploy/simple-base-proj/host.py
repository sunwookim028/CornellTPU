...
def main():
    ...
    # no need to parse bc we know name of .bit and .hwh
    bitstream_path:str = "simple-base-proj.bit"
    hwh_path = "simple-base-proj.hwh"
    ...
    const_driver = overlay.const_driver_v1_0_0
