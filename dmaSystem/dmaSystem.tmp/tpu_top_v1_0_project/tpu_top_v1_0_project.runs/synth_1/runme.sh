...
HD_PWD='c:/cornelltpu/dmasystem/dmasystem.tmp/tpu_top_v1_0_project/tpu_top_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tpu_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tpu_top.tcl
