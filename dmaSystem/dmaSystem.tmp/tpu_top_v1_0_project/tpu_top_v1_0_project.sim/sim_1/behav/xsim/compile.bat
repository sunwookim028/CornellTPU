...
REM
REM Generated by Vivado on Thu Nov 06 13:34:00 -0500 2025
...
echo "xvlog --incr --relax -L uvm -prj tpu_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tpu_top_vlog.prj -log xvlog.log
