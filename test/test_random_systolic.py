...
async def run_one_case(dut, X, W, OUT):
    ...
    dut.rst.value = 0
    dut.sys_weight_in_11.value = to_fixed(W[0][3])
    dut.sys_accept_w_1.value = 1
    await RisingEdge(dut.clk)

    # Cycle 2
    dut.sys_weight_in_11.value = to_fixed(W[0][2])
    dut.sys_accept_w_1.value = 1
    dut.sys_weight_in_12.value = to_fixed(W[1][3])
    ...
    dut.sys_accept_w_1.value = 1
    dut.sys_weight_in_12.value = to_fixed(W[1][2])
    dut.sys_accept_w_2.value = 1
    dut.sys_weight_in_13.value = to_fixed(W[2][3])
    ...
    dut.sys_accept_w_2.value = 1
    dut.sys_weight_in_13.value = to_fixed(W[2][2])
    dut.sys_accept_w_3.value = 1
    dut.sys_weight_in_14.value = to_fixed(W[3][3])
    ...
    dut.sys_accept_w_2.value   = 1
    dut.sys_weight_in_13.value = to_fixed(W[2][1])
    dut.sys_accept_w_3.value   = 1
    dut.sys_weight_in_14.value = to_fixed(W[3][2])
    dut.sys_accept_w_4.value   = 1
    ...
    dut.sys_weight_in_13.value = to_fixed(W[2][0])
    dut.sys_accept_w_3.value   = 1
    dut.sys_weight_in_14.value = to_fixed(W[3][1])
    dut.sys_accept_w_4.value   = 1
    ...
    dut.sys_weight_in_14.value = to_fixed(W[3][0])
    dut.sys_accept_w_4.value   = 1
    ...
    while int(dut.sys_valid_out_44.value) == 0:
        await RisingEdge(dut.clk)
        assert int(dut.sys_data_out_44.value) == to_fixed(OUT[3][3])
    await RisingEdge(dut.clk)
